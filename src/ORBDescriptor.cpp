...
ORBdescriptor::ORBdescriptor(const cv::Mat& _image, float _scaleFactor, int _nlevels,
                             int _edgeThreshold, int _patchSize):
...
void ORBdescriptor::computeOrbDescriptor(const cv::KeyPoint& kpt,
                                         uchar* desc) {
    ...
    const uchar* center = &mBluredImagePyramid.at<uchar>(
