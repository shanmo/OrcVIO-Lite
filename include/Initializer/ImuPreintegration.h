//
// Added by xiaochen at 19-8-14.
// Methods for IMU preintegration.
...
class IntegrationBase
{
  public:
    ...
    IntegrationBase(const Eigen::Vector3d &_acc_0, const Eigen::Vector3d &_gyr_0,
                    ...
                    const double& acc_n, const double& acc_w, const double& gyr_n, 
                    const double& gyr_w)
        : acc_0{_acc_0}, gyr_0{_gyr_0}, linearized_acc{_acc_0}, linearized_gyr{_gyr_0},
          linearized_ba{_linearized_ba}, linearized_bg{_linearized_bg},
            jacobian{Eigen::Matrix<double, 15, 15>::Identity()}, covariance{Eigen::Matrix<double, 15, 15>::Zero()},
          sum_dt{0.0}, delta_p{Eigen::Vector3d::Zero()}, delta_q{Eigen::Quaterniond::Identity()}, delta_v{Eigen::Vector3d::Zero()}, 
          ACC_N{acc_n}, ACC_W{acc_w}, GYR_N{gyr_n}, GYR_W{gyr_w}
    {
                                          ...
                                          const Eigen::Vector3d &Pj, const Eigen::Quaterniond &Qj, const Eigen::Vector3d &Vj, const Eigen::Vector3d &Baj, const Eigen::Vector3d &Bgj)
    {
        ...
        Eigen::Quaterniond corrected_delta_q = delta_q * getSmallAngleQuaternion(dq_dbg * dbg);
